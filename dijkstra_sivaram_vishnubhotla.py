"""dijkstra_sivaram_vishnubhotla.ipynb


Link to github repository - https://github.com/VVSDheeraj/Dijkstra-Planner-Visualisation
Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1KnWtY0bPJZwfh57_P9PDY175yGX9N8HQ
...
#Import all the necessary dependancies and libraries
import numpy as np
import cv2
import heapq
# import cv2.imshow
...
# Calculate the coordinates of the vertices for rotated hexagon
vertices = []
for i in range(6):
...
# Calculate the coordinates of the vertices for rotated hexagon without clearance
vertices = []
for i in range(6):
    angle_deg = 60 * i + 330  # Adjusting angle for 30 degrees clockwise rotation
    angle_rad = np.deg2rad(angle_deg)
...
"""**Printing the total time taken to complete the algorithem**"""
